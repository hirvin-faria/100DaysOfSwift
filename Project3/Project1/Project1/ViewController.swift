...
//  Project1
//
//  Created by HirvinFaria on 28/07/20.
...
class ViewController: UITableViewController {
    ...
    @objc func shareApp() {
        let ac = UIAlertController(title: "Share this app", message: "Share for your friends", preferredStyle: .alert)
        ac.addAction(UIAlertAction(title: "Share", style: .default, handler: nil))
